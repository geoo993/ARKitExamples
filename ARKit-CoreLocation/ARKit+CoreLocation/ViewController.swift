...
class ViewController: UIViewController, MKMapViewDelegate, SceneLocationViewDelegate {
    ...
    var firstLocationFound: CLLocation!
...
//
            ...
            if touch.view != nil {
                if (mapView == touch.view! ||
                    ...
                    if location.x <= 40 && adjustNorthByTappingSidesOfScreen {
                        ...
                        self.annotationNode = LocationAnnotationNode(location: firstLocationFound, image: image)
                        self.annotationNode.scaleRelativeToDistance = true
    ...
    //MARK: SceneLocationViewDelegate When a location estimate is found
    func sceneLocationViewDidAddSceneLocationEstimate(sceneLocationView: SceneLocationView, position: SCNVector3, location: CLLocation) {
        print("add scene location estimate, position: \(position), location: \(location.coordinate), accuracy: \(location.horizontalAccuracy), date: \(location.timestamp)")
        firstLocationFound = location
    }
    ...
    //MARK: SceneLocationViewDelegate When a node is added
    ...
    func sceneLocationViewDidUpdateLocationAndScaleOfLocationNode(sceneLocationView: SceneLocationView, locationNode: LocationNode) {
        self.annotationNode = locationNode as! LocationAnnotationNode
    }
}
